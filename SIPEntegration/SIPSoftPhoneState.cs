...
namespace SIPSorcery.SoftPhone
{
    public class SIPSoftPhoneState : IConfigurationSectionHandler
    {
        ...
        public static string SIPUsername = "";    // Get the SIP username from the config file.
        public static string SIPPassword = "";    // Get the SIP password from the config file.
        public static string SIPServer = "";        // Get the SIP server from the config file.
        public static string SIPFromName = "";    // Get the SIP From display name from the config file.
        ...
        static SIPSoftPhoneState()
        {
            ...
            {
                string[] infos = File.ReadAllLines(Environment.CurrentDirectory + "\\netgsm.txt");
